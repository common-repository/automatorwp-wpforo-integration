...
class AutomatorWP_wpForo_Create_Reply extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User replies to a topic of a forum', 'automatorwp-wpforo-integration' ),
            'select_option'     => __( 'User <strong>replies</strong> to a topic of a forum', 'automatorwp-wpforo-integration' ),
            /* translators: %1$s: Topic title. %2$s: Forum title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User replies to %1$s of %2$s %3$s time(s)', 'automatorwp-wpforo-integration' ), '{topic}', '{forum}', '{times}' ),
            /* translators: %1$s: Topic title. %2$s: Forum title. */
            'log_label'         => sprintf( __( 'User replies to %1$s of %2$s', 'automatorwp-wpforo-integration' ), '{topic}', '{forum}' ),
                ...
                'topic' => array(
                    ...
                    'fields' => array(
                        'topic' => automatorwp_utilities_post_field( array(
                            'name' => __( 'Topic:', 'automatorwp-wpforo-integration' ),
                            'option_none_label' => __( 'any topic', 'automatorwp-wpforo-integration' ),
                ...
                'forum' => array(
                    ...
                    'fields' => array(
                        'forum' => automatorwp_utilities_post_field( array(
                            'name' => __( 'Forum:', 'automatorwp-wpforo-integration' ),
                            'option_none_label' => __( 'any forum', 'automatorwp-wpforo-integration' ),
