...
class AutomatorWP_wpForo_Create_Topic extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User creates a topic on a forum', 'automatorwp-wpforo-integration' ),
            'select_option'     => __( 'User <strong>creates a topic</strong> on a forum', 'automatorwp-wpforo-integration' ),
            /* translators: %1$s: Forum title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User creates a topic on %1$s of %2$s time(s)', 'automatorwp-wpforo-integration' ), '{forum}', '{times}' ),
            /* translators: %1$s: Forum title. */
            'log_label'         => sprintf( __( 'User creates a topic on %1$s', 'automatorwp-wpforo-integration' ), '{forum}' ),
